				...
				<table class="table table-hover">
					...
					<c:forEach items="${noticeList}" var="noticeList">
						<tr>
							...
							<td><a href="/notice/detail?id=${noticeList.id}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}"><c:out value="${noticeList.title}" /></a></td>
							<td><c:out value="${noticeList.writer}" /></td>
							<td><fmt:formatDate value="${noticeList.regdate}"
