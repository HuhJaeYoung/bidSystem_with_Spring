...
public class FileUtils {
	private static final String filePath = "C:\\jaeyoung\\file\\notice\\"; // 파일이 저장될 위치
	...
	public List<Map<String, Object>> parseInsertFileInfo(NoticeVO noticeVO, 
		...
		*/
		...
		Iterator<String> iterator = noticeRequest.getFileNames();
		...
		while(iterator.hasNext()) {
			multipartFile = noticeRequest.getFile(iterator.next());
